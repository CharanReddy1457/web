...
- Provides a login interface for **institute credentials**.
- Helps users connect to the **campus internet and network resources**.
- Displays **NOC / IT Helpdesk** information for support.
- Works across desktop and mobile devices.
- Uses a modern **Liquid Glass / Glassmorphism** interface.
...
Accept Terms
       ↓
Enter Institute Credentials
       ↓
Connect to Campus Wi-Fi
       ↓
Access Internet & Campus Resources
